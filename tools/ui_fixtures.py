...
_CURATED_MATCHES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "is_pro": True,
        "player_name": "ZywOo",
        "pro_teams": "Vitality vs NAVI",
        "pro_event": "ESL Pro League",
        "pro_score": "16-11 CT",
    },
    {
    ...
    },
    {
        ...
        "is_pro": True,
        "player_name": "NiKo",
        "pro_teams": "G2 vs FaZe",
        "pro_event": "BLAST Paris Major",
        "pro_score": "16-13 T",
    },
    {
        ...
        rows.append(
            {
                ...
                "clutch_win_pct": (
                    0.0
                    if clutches_total == 0
                    else round(min(i % 2, clutches_total) / clutches_total, 2)
                ),
...
MATCH_DETAIL_ROUNDS: list[dict[str, Any]] = [
    ...
    _md_round(
        9, "T", False, 2, 1, 168, 5200, False, None, 2, "post-plant hold failed", sev="warning"
    ),
    _md_round(10, "T", False, 0, 1, 32, 5200, False, None, 4, "crossfire death top-mid", od=True),
    ...
    _md_round(14, "CT", False, 1, 1, 58, 4200, False, "lost", 3, "B rush · late rotate", od=True),
    _md_round(15, "CT", True, 1, 0, 72, 4800, False, "defused", 1, "hold connector"),
    _md_round(16, "CT", True, 2, 0, 148, 5200, True, "defused", 2, "retake 2v4 win", sev="success"),
    ...
    _md_round(
        ...
        "lost",
        2,
        "over-peeked vs flash",
        sev="warning",
        od=True,
    ),
    _md_round(20, "CT", True, 2, 1, 112, 5200, False, "defused", 1, "solid hold B"),
    _md_round(21, "CT", False, 0, 1, 28, 5200, False, "lost", 4, "caught repositioning", od=True),
    ...
    _md_round(
        24, "CT", True, 2, 1, 98, 5200, False, "defused", 0, "match point · win 16-8", sev="success"
    ),
]
...
MATCH_DETAIL_MOMENTS: list[dict[str, Any]] = [
    {
        "description": "1v2 clutch win on palace",
        "type": "play",
        "round": 4,
        "start_tick": 61440,
        "peak_tick": 61888,
    ...
    {
        "description": "Over-peek jungle vs mid-hold",
        "type": "mistake",
        "round": 3,
        "start_tick": 48120,
        "peak_tick": 48310,
    ...
    {
        "description": "Post-plant hold failed",
        "type": "mistake",
        "round": 9,
        "start_tick": 118400,
        "peak_tick": 118750,
    ...
    {
        "description": "Opening pick at palace",
        "type": "play",
        "round": 11,
        "start_tick": 142080,
        "peak_tick": 142200,
...
COACH_INSIGHTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "title": "Pistol round buy pattern",
        "message": "Armor pickup rate 42% on loss round 2 — consider full-buy " "strategy.",
        "severity": "Low",
        "focus_area": "",
        "created_at": "",
        "player_name": "macena",
...
_TACTICAL_ROSTER: list[dict[str, Any]] = [
    dict(
        ...
        money=3500,
        weapon="M4A1-S",
        inv=["M4A1-S", "USP", "flash", "flash", "smoke"],
        defuser=True,
        kda=(11, 8, 2),
    ),
    dict(
        ...
        money=1200,
        weapon="AWP",
        inv=["AWP", "Deagle", "smoke", "smoke", "HE", "moly"],
        kda=(9, 9, 1),
    ),
    dict(
        pid=3,
    ...
    dict(
        ...
        money=8100,
        weapon="M4A1-S",
        inv=["M4A1-S", "P250", "flash", "flash", "smoke", "HE"],
        kda=(8, 9, 3),
    ),
    dict(
        pid=5,
    ...
    dict(
        ...
        money=6400,
        weapon="AK-47",
        inv=["AK-47", "Glock", "flash", "flash", "smoke", "HE"],
        kda=(14, 7, 3),
    ),
    dict(
        pid=7,
        ...
        money=4700,
        weapon="AK-47",
        inv=["AK-47", "P250", "flash", "smoke", "smoke"],
        kda=(7, 8, 5),
    ),
    dict(
        pid=8,
        ...
        money=2100,
        weapon="AWP",
        inv=["AWP", "Deagle", "flash", "smoke", "smoke"],
        kda=(12, 6, 1),
    ),
    dict(
        pid=9,
        ...
        money=5200,
        weapon="AK-47",
        inv=["AK-47", "USP", "flash", "flash", "moly"],
        kda=(10, 9, 2),
    ),
    dict(
        pid=10,
...
def _tactical_nades(tick: int) -> list:
    ...
    return [
        NadeState(
            ...
            y=sy,
            z=0.0,
            starting_tick=tick - 128,
            ending_tick=tick + 960,
        ),
        NadeState(
            base_id=902,
            ...
            y=my,
            z=0.0,
            starting_tick=tick - 64,
            ending_tick=tick + 384,
        ),
    ]
...
TACTICAL_GHOST_PAYLOAD: dict[str, Any] = {
    ...
    "you": {
        "side": "T",
        "map": "Mirage",
        "path": "T spawn → jungle → A",
        "decision": "4.2s @ connector",
        "outcome": "died",
        "died": True,
    },
    "ghost": {
        "context": "Same round · ESL Paris",
        "path": "T spawn → palace → A",
        "decision": "8.7s @ palace",
        "outcome": "won",
    },
    "divergence": {
    ...
    "smokes": [{"x": 640 / _GHOST_PANE_W, "y": 320 / _GHOST_PANE_H, "label": "smoke (ghost)"}],
}
...
def inject_tactical_viewer(screen: Any) -> None:
    ...
    screen._on_demo_loaded({"de_mirage": (_tactical_demo_frames(), [], _tactical_segments())})
