...
|------|-------|-----------|
| `headless_validator.py` | Gate di regressione con 26 fasi di validazione | Validazione |
...
Questo e lo strumento piu importante dell'intero progetto. Esegue **26 fasi di validazione automatizzata** e deve terminare con codice di uscita 0 prima di qualsiasi commit. E inoltre collegato come hook pre-commit.
