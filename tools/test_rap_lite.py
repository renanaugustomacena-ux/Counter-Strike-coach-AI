...
def test_rap_lite():
    ...
    model.eval()
    print("[OK] rap-lite instantiated via ModelFactory")
    ...
    print("[OK] Memory layer is RAPMemoryLite (LSTM-based)")
