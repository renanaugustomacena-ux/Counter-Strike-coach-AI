...
| R6 | Design/decisioni owner (preparare analisi complete) | #61 26-SCHEMA-02 connect-feature (implementare o rimuovere) · C11 26-NORM-01 SSOT tick-rate · #62 eslint web (cablare flat-config o rimuovere script) · **NUOVO:** bump sentence-transformers→transformers 5.x (chiude la famiglia RCE VEX'd; richiede re-embedding RAG, EMBEDDING_VERSION bump — legare alla finestra R8) | decisione owner |
| R7 | Ricerca JEPA "tesori" | 26-LEJEPA-01 SIGReg vs EMA-teacher (studio; invalida checkpoint) · A1 confronto LeJEPA (AUDIT §12.2) · Studio "Visione privilegiata al training" (Fase 3 piano maestro — deliverable `docs/Studies/`, NON ancora esistente) | ricerca, zero codice runtime |
