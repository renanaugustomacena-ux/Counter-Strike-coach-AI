...
1. **Headless Validator** — Gate veloce (291+ controlli in 23 fasi, <20s, deve passare prima del completamento task)
2. **Pytest** — Validazione logica (oltre 1,515 test)
3. **Backend Validator** — Controlli di build e salute (40 controlli)
4. **Goliath Hospital** — Suite diagnostica completa

## Strumenti Principali

- `headless_validator.py` — Gate di validazione veloce con 291+ controlli in 23 fasi
