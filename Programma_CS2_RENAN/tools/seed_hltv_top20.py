...
PLAYERS = [
    ...
    # FUT Esports (13286)
    {
        "hltv_id": 20584,
        "nickname": "dem0n",
        "real_name": "Dmytro Myroshnychenko",
        "country": "Ukraine",
        "team_id": 13286,
    },
    {
    ...
    },
    {
        "hltv_id": 23553,
        "nickname": "dziugss",
        "real_name": "Dziugas Steponavicius",
        "country": "Lithuania",
        "team_id": 13286,
    },
    # 3DMAX (4914)
    ...
    },
    {
        "hltv_id": 8738,
        "nickname": "EliGE",
        "real_name": "Jonathan Jablonowski",
    ...
    },
    {
        "hltv_id": 21983,
        "nickname": "Chr1zN",
        "real_name": "Christoffer Storgaard",
        "country": "Denmark",
        "team_id": 7175,
    },
    {
    ...
    },
    {
        "hltv_id": 9254,
        "nickname": "mopoz",
        "real_name": "Alejandro Fernandez-Quejo",
        "country": "Spain",
        "team_id": 13404,
    },
    {
        "hltv_id": 18749,
        "nickname": "sausol",
        "real_name": "Pere Solsona Saumell",
        "country": "Spain",
        "team_id": 13404,
    },
    {
        "hltv_id": 19509,
        "nickname": "dav1g",
        "real_name": "David Granado Bermudo",
        "country": "Spain",
        "team_id": 13404,
    },
    {
    ...
    },
    {
        "hltv_id": 7938,
        "nickname": "XANTARES",
        "real_name": "Ismailcan Dortkardes",
        "country": "Turkey",
        "team_id": 11861,
    },
    {
...
PLAYER_STATS = {
    ...
    11893: {
        ...
        "headshot_pct": 42.0,
        "maps_played": 230,
        "opening_kill_ratio": 1.35,
        "opening_duel_win_pct": 57.0,
    },
    # donk — HLTV #2 of 2025
    21167: {
        "rating_2_0": 1.25,
        ...
        "headshot_pct": 55.0,
        "maps_played": 180,
        "opening_kill_ratio": 1.20,
        "opening_duel_win_pct": 55.0,
    },
    # ropz — HLTV #3 of 2025
    11816: {
        "rating_2_0": 1.12,
    ...
    19230: {
        ...
        "headshot_pct": 38.0,
        "maps_played": 190,
        "opening_kill_ratio": 1.30,
        "opening_duel_win_pct": 56.0,
    },
    ...
    24144: {
        ...
        "headshot_pct": 50.0,
        "maps_played": 140,
        "opening_kill_ratio": 1.10,
        "opening_duel_win_pct": 52.0,
    },
    ...
    9960: {
        ...
        "headshot_pct": 52.0,
        "maps_played": 210,
        "opening_kill_ratio": 1.05,
        "opening_duel_win_pct": 51.0,
    },
    ...
    429: {
        ...
        "headshot_pct": 40.0,
        "maps_played": 220,
        "opening_kill_ratio": 0.85,
        "opening_duel_win_pct": 46.0,
    },
    # apEX (Vitality) — IGL
    7322: {
        "rating_2_0": 0.92,
        ...
        "headshot_pct": 38.0,
        "maps_played": 230,
        "opening_kill_ratio": 0.90,
        "opening_duel_win_pct": 47.0,
    },
...
def main():
    ...
    with db.get_session() as session:
        for t in TEAMS:
            existing = session.exec(select(ProTeam).where(ProTeam.hltv_id == t["hltv_id"])).first()
            if existing:
    ...
    with db.get_session() as session:
        for p in PLAYERS:
            ...
            if existing:
                ...
                players_inserted += 1
            print(
                f"  {'[UPD]' if existing else '[NEW]'} {p['nickname']:>12} (hltv_id={p['hltv_id']}, team={p['team_id']})"
            )
    ...
    with db.get_session() as session:
        for p in PLAYERS:
            ...
            existing_card = session.exec(
                select(ProPlayerStatCard).where(ProPlayerStatCard.player_id == hid)
            ).first()
            ...
            print(
                f"  {'[UPD]' if existing_card else '[NEW]'} {p['nickname']:>12}  "
