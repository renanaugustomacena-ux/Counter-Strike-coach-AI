...
1. **Headless Validator** — Gate rápido (291+ verificacoes em 23 fases, <20s, deve passar antes da conclusão da tarefa)
2. **Pytest** — Validação de lógica (mais de 1,515 testes)
3. **Backend Validator** — Verificações de build e saúde (40 verificações)
4. **Goliath Hospital** — Suíte de diagnóstico abrangente

## Ferramentas Principais

- `headless_validator.py` — Gate de validação rápido com 291+ verificacoes em 23 fases
