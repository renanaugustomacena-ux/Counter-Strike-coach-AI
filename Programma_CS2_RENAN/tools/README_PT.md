...
1. **Headless Validator** — Gate rápido (79 verificações, <20s, deve passar antes da conclusão da tarefa)
...
- `headless_validator.py` — Gate de validação rápido com 79 verificações
