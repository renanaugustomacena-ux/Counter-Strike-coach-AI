...
1. **Headless Validator** — Fast gate (291+ checks across 23 phases, <20s, must pass before task completion)
2. **Pytest** — Logic validation (1,515+ tests)
3. **Backend Validator** — Build and health checks (40 checks)
4. **Goliath Hospital** — Comprehensive diagnostic suite

## Core Tools

- `headless_validator.py` — Fast validation gate with 291+ checks across 23 phases
