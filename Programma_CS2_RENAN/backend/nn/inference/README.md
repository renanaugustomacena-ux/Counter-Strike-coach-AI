...
- Tensors come from a `TensorFactory` instantiated with `TrainingTensorConfig()` (64×64 resolution for all channels), matching the training resolution (F-0026 closed).
