...
EVENT_REGISTRY: Dict[str, GameEventSpec] = {
    ...
    "bomb_planted": GameEventSpec(
        ...
        priority="critical",
        implemented=False,
        notes="Essential for post-plant analysis, retake scenarios, and game tree state transitions.",
    ),
    "bomb_defused": GameEventSpec(
        ...
        priority="critical",
        implemented=False,
        notes="Complements bomb_planted for round outcome classification.",
    ),
