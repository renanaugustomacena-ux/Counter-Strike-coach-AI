...
├── pro_baseline.csv                 # Professional baseline statistics
...
| `Maps01_BombPlantOutcomes01.csv` | Bomb plant outcome data | Economy analysis |
...
- `dataset.csv` and `pro_baseline.csv` are generated by the training pipeline, not hand-edited
