> **STATUS: ALL 9 G-ISSUES RESOLVED (2026-03-08)**
> This document is retained as architectural reference (dependency chains, mathematical formulas, DB schema map).
> See MEMORY.md for per-issue resolution details. G-05 permanently deferred (requires pro-annotated dataset).
